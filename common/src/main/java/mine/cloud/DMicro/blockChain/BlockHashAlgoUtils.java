...
public class BlockHashAlgoUtils {
    public static String encodeDataBySHA_256(Map<String,String> data){
        try {
            ...
            StringBuffer hexString = getHexHashStringBuffer(hash);
    ...
    public static String encodeDataBySHA_256(String data){
        try {
            MessageDigest digest = MessageDigest.getInstance("SHA-256");
            //Applies sha256 to our input
            ObjectMapper mapper = new ObjectMapper();
    ...
    private static StringBuffer getHexHashStringBuffer(byte[] hash) {
